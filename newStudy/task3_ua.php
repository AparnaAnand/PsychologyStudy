...
$limit= $_SESSION['timelimit'];
	...
	if(isset($_POST['next'])) {
		$_SESSION['TotBox3']=$_POST['TotBox'];
		$_SESSION['Cat3']=$_POST['cat'];
		$_SESSION['TimeOnEach3']=$_POST['TimeOnEach'];
		$_SESSION['TotalElapsed3']=$_POST['TotalElapsed'];
		$_SESSION['Repeated3']=$_POST['Repeated'];
		$_SESSION['Sequence3']=$_POST['Sequence'];
		$_SESSION['Useful3']=$_POST['Useful'];
		$_SESSION['Useless3']=$_POST['Useless'];
		$_SESSION['UsefulTime3']=$_POST['UsefulTime'];
		$_SESSION['UselessTime3']=$_POST['UselessTime'];
		$_SESSION['AverageTime3']=$_POST['AverageTime'];
		$_SESSION['AvgRepeated3']=$_POST['AvgRepeated'];
		$_SESSION['TotRepeated3']=$_POST['TotRepeated'];
		$_SESSION['TotRepCat3']=$_POST['TotRepCat'];
		$_SESSION['TotFulTime3']=$_POST['TotFulTime'];
		$_SESSION['TotLessTime3']=$_POST['TotLessTime'];
		$_SESSION['AvgFulTime3']=$_POST['AvgFulTime'];
		$_SESSION['AvgLessTime3']=$_POST['AvgLessTime'];
		$_SESSION['UsefulRep3']=$_POST['UsefulRep'];
		$_SESSION['UselessRep3']=$_POST['UselessRep'];
		$_SESSION['AvgUsefulRep3']=$_POST['AvgUsefulRep'];
		$_SESSION['AvgUselessRep3']=$_POST['AvgUselessRep'];
		$_SESSION['TotTimeCat3']=$_POST['TotTimeCat'];
		header("location:ans3_ua.php?chosen=".$chosen);
		exit;
	}
