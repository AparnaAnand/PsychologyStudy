...
$limit= $_SESSION['timelimit'];
	...
	if(isset($_POST['next'])) {
		$_SESSION['TotBox2']=$_POST['TotBox'];
		$_SESSION['Cat2']=$_POST['cat'];
		$_SESSION['TimeOnEach2']=$_POST['TimeOnEach'];
		$_SESSION['TotalElapsed2']=$_POST['TotalElapsed'];
		$_SESSION['Repeated2']=$_POST['Repeated'];
		$_SESSION['Sequence2']=$_POST['Sequence'];
		$_SESSION['Useful2']=$_POST['Useful'];
		$_SESSION['Useless2']=$_POST['Useless'];
		$_SESSION['UsefulTime2']=$_POST['UsefulTime'];
		$_SESSION['UselessTime2']=$_POST['UselessTime'];
		$_SESSION['AverageTime2']=$_POST['AverageTime'];
		$_SESSION['AvgRepeated2']=$_POST['AvgRepeated'];
		$_SESSION['TotRepeated2']=$_POST['TotRepeated'];
		$_SESSION['TotRepCat2']=$_POST['TotRepCat'];
		$_SESSION['TotFulTime2']=$_POST['TotFulTime'];
		$_SESSION['TotLessTime2']=$_POST['TotLessTime'];
		$_SESSION['AvgFulTime2']=$_POST['AvgFulTime'];
		$_SESSION['AvgLessTime2']=$_POST['AvgLessTime'];
		$_SESSION['UsefulRep2']=$_POST['UsefulRep'];
		$_SESSION['UselessRep2']=$_POST['UselessRep'];
		$_SESSION['AvgUsefulRep2']=$_POST['AvgUsefulRep'];
		$_SESSION['AvgUselessRep2']=$_POST['AvgUselessRep'];
		$_SESSION['TotTimeCat2']=$_POST['TotTimeCat'];
		header("location:ans2_ua.php?chosen=".$chosen);
		exit;
	}
