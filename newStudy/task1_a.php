...
$limit= $_SESSION['timelimit'];
	...
	if(isset($_POST['next'])) {
		$_SESSION['TotBox5']=$_POST['TotBox'];
		$_SESSION['Cat5']=$_POST['cat'];
		$_SESSION['TimeOnEach5']=$_POST['TimeOnEach'];
		$_SESSION['TotalElapsed5']=$_POST['TotalElapsed'];
		$_SESSION['Repeated5']=$_POST['Repeated'];
		$_SESSION['Sequence5']=$_POST['Sequence'];
		$_SESSION['Useful5']=$_POST['Useful'];
		$_SESSION['Useless5']=$_POST['Useless'];
		$_SESSION['UsefulTime5']=$_POST['UsefulTime'];
		$_SESSION['UselessTime5']=$_POST['UselessTime'];
		$_SESSION['AverageTime5']=$_POST['AverageTime'];
		$_SESSION['AvgRepeated5']=$_POST['AvgRepeated'];
		$_SESSION['TotRepeated5']=$_POST['TotRepeated'];
		$_SESSION['TotRepCat5']=$_POST['TotRepCat'];
		$_SESSION['TotFulTime5']=$_POST['TotFulTime'];
		$_SESSION['TotLessTime5']=$_POST['TotLessTime'];
		$_SESSION['AvgFulTime5']=$_POST['AvgFulTime'];
		$_SESSION['AvgLessTime5']=$_POST['AvgLessTime'];
		$_SESSION['UsefulRep5']=$_POST['UsefulRep'];
		$_SESSION['UselessRep5']=$_POST['UselessRep'];
		$_SESSION['AvgUsefulRep5']=$_POST['AvgUsefulRep'];
		$_SESSION['AvgUselessRep5']=$_POST['AvgUselessRep'];
		$_SESSION['TotTimeCat5']=$_POST['TotTimeCat'];
		header("location:ans1_a.php?chosen=".$chosen);
		exit;
	}
