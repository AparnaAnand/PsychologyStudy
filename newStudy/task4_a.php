...
$limit= $_SESSION['timelimit'];
	...
	if(isset($_POST['next'])) {
		$_SESSION['TotBox8']=$_POST['TotBox'];
		$_SESSION['Cat8']=$_POST['cat'];
		$_SESSION['TimeOnEach8']=$_POST['TimeOnEach'];
		$_SESSION['TotalElapsed8']=$_POST['TotalElapsed'];
		$_SESSION['Repeated8']=$_POST['Repeated'];
		$_SESSION['Sequence8']=$_POST['Sequence'];
		$_SESSION['Useful8']=$_POST['Useful'];
		$_SESSION['Useless8']=$_POST['Useless'];
		$_SESSION['UsefulTime8']=$_POST['UsefulTime'];
		$_SESSION['UselessTime8']=$_POST['UselessTime'];
		$_SESSION['AverageTime8']=$_POST['AverageTime'];
		$_SESSION['AvgRepeated8']=$_POST['AvgRepeated'];
		$_SESSION['TotRepeated8']=$_POST['TotRepeated'];
		$_SESSION['TotRepCat8']=$_POST['TotRepCat'];
		$_SESSION['TotFulTime8']=$_POST['TotFulTime'];
		$_SESSION['TotLessTime8']=$_POST['TotLessTime'];
		$_SESSION['AvgFulTime8']=$_POST['AvgFulTime'];
		$_SESSION['AvgLessTime8']=$_POST['AvgLessTime'];
		$_SESSION['UsefulRep8']=$_POST['UsefulRep'];
		$_SESSION['UselessRep8']=$_POST['UselessRep'];
		$_SESSION['AvgUsefulRep8']=$_POST['AvgUsefulRep'];
		$_SESSION['AvgUselessRep8']=$_POST['AvgUselessRep'];
		$_SESSION['TotTimeCat8']=$_POST['TotTimeCat'];
		header("location:ans4_a.php?chosen=".$chosen);
		exit;
	}
