...
$limit= $_SESSION['timelimit'];
	...
	if(isset($_POST['next'])) {
		$_SESSION['TotBox6']=$_POST['TotBox'];
		$_SESSION['Cat6']=$_POST['cat'];
		$_SESSION['TimeOnEach6']=$_POST['TimeOnEach'];
		$_SESSION['TotalElapsed6']=$_POST['TotalElapsed'];
		$_SESSION['Repeated6']=$_POST['Repeated'];
		$_SESSION['Sequence6']=$_POST['Sequence'];
		$_SESSION['Useful6']=$_POST['Useful'];
		$_SESSION['Useless6']=$_POST['Useless'];
		$_SESSION['UsefulTime6']=$_POST['UsefulTime'];
		$_SESSION['UselessTime6']=$_POST['UselessTime'];
		$_SESSION['AverageTime6']=$_POST['AverageTime'];
		$_SESSION['AvgRepeated6']=$_POST['AvgRepeated'];
		$_SESSION['TotRepeated6']=$_POST['TotRepeated'];
		$_SESSION['TotRepCat6']=$_POST['TotRepCat'];
		$_SESSION['TotFulTime6']=$_POST['TotFulTime'];
		$_SESSION['TotLessTime6']=$_POST['TotLessTime'];
		$_SESSION['AvgFulTime6']=$_POST['AvgFulTime'];
		$_SESSION['AvgLessTime6']=$_POST['AvgLessTime'];
		$_SESSION['UsefulRep6']=$_POST['UsefulRep'];
		$_SESSION['UselessRep6']=$_POST['UselessRep'];
		$_SESSION['AvgUsefulRep6']=$_POST['AvgUsefulRep'];
		$_SESSION['AvgUselessRep6']=$_POST['AvgUselessRep'];
		$_SESSION['TotTimeCat6']=$_POST['TotTimeCat'];
		header("location:ans2_a.php?chosen=".$chosen);
		exit;
	}
