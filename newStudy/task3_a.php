...
$limit= $_SESSION['timelimit'];
	...
	if(isset($_POST['next'])) {
		$_SESSION['TotBox7']=$_POST['TotBox'];
		$_SESSION['Cat7']=$_POST['cat'];
		$_SESSION['TimeOnEach7']=$_POST['TimeOnEach'];
		$_SESSION['TotalElapsed7']=$_POST['TotalElapsed'];
		$_SESSION['Repeated7']=$_POST['Repeated'];
		$_SESSION['Sequence7']=$_POST['Sequence'];
		$_SESSION['Useful7']=$_POST['Useful'];
		$_SESSION['Useless7']=$_POST['Useless'];
		$_SESSION['UsefulTime7']=$_POST['UsefulTime'];
		$_SESSION['UselessTime7']=$_POST['UselessTime'];
		$_SESSION['AverageTime7']=$_POST['AverageTime'];
		$_SESSION['AvgRepeated7']=$_POST['AvgRepeated'];
		$_SESSION['TotRepeated7']=$_POST['TotRepeated'];
		$_SESSION['TotRepCat7']=$_POST['TotRepCat'];
		$_SESSION['TotFulTime7']=$_POST['TotFulTime'];
		$_SESSION['TotLessTime7']=$_POST['TotLessTime'];
		$_SESSION['AvgFulTime7']=$_POST['AvgFulTime'];
		$_SESSION['AvgLessTime7']=$_POST['AvgLessTime'];
		$_SESSION['UsefulRep7']=$_POST['UsefulRep'];
		$_SESSION['UselessRep7']=$_POST['UselessRep'];
		$_SESSION['AvgUsefulRep7']=$_POST['AvgUsefulRep'];
		$_SESSION['AvgUselessRep7']=$_POST['AvgUselessRep'];
		$_SESSION['TotTimeCat7']=$_POST['TotTimeCat'];
		header("location:ans3_a.php?chosen=".$chosen);
		exit;
	}
