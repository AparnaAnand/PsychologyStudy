...
$limit= $_SESSION['timelimit'];
	...
	if(isset($_POST['next'])) {
		$_SESSION['TotBox']=$_POST['TotBox'];
		$_SESSION['Cat']=$_POST['cat'];
		$_SESSION['TimeOnEach']=$_POST['TimeOnEach'];
		$_SESSION['TotalElapsed']=$_POST['TotalElapsed'];
		$_SESSION['Repeated']=$_POST['Repeated'];
		$_SESSION['Sequence']=$_POST['Sequence'];
		$_SESSION['Useful']=$_POST['Useful'];
		$_SESSION['Useless']=$_POST['Useless'];
		$_SESSION['UsefulTime']=$_POST['UsefulTime'];
		$_SESSION['UselessTime']=$_POST['UselessTime'];
		$_SESSION['AverageTime']=$_POST['AverageTime'];
		$_SESSION['AvgRepeated']=$_POST['AvgRepeated'];
		$_SESSION['TotRepeated']=$_POST['TotRepeated'];
		$_SESSION['TotRepCat']=$_POST['TotRepCat'];
		$_SESSION['TotFulTime']=$_POST['TotFulTime'];
		$_SESSION['TotLessTime']=$_POST['TotLessTime'];
		$_SESSION['AvgFulTime']=$_POST['AvgFulTime'];
		$_SESSION['AvgLessTime']=$_POST['AvgLessTime'];
		$_SESSION['UsefulRep']=$_POST['UsefulRep'];
		$_SESSION['UselessRep']=$_POST['UselessRep'];
		$_SESSION['AvgUsefulRep']=$_POST['AvgUsefulRep'];
		$_SESSION['AvgUselessRep']=$_POST['AvgUselessRep'];
		$_SESSION['TotTimeCat']=$_POST['TotTimeCat'];
		header("location:ans1_ua.php?chosen=".$chosen);
		exit;
	}
